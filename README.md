...
- **Документы для бухгалтерии**: счёт на оплату, накладная ТОРГ-12, УПД,
  акт сверки — выгрузка в Excel (см. **`БУХГАЛТЕРИЯ.md`**)
...
- Python 3.12+ (на 3.10–3.11 установится Django 5.2 LTS)
- pip
