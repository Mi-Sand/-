...
class CounterpartySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # DRF сам собирает проверку уникальности по ограничению модели и
        # отвечает на неё своим сообщением — «Поля inn, kpp должны
        # производить массив с уникальными значениями». Понять его
        # нельзя, поэтому проверка своя, ниже: она называет карточку,
        # которая уже заведена. Ограничение в базе при этом остаётся —
        # оно и есть настоящая защита.
        validators = []
